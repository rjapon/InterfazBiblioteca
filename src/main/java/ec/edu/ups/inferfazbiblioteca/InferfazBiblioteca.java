 ...
 * @author Asus
 */
public class InferfazBiblioteca {

    public static void main(String[] args) {

        //-----------------------------------------//
        Frame home = new Frame("Pagina Principal");
        //-----------------------------------------//
        ...
        Button devolver = new Button("Devolver Libro");
        //-----------------------------------------//
        Label titulo = new Label("Titulo", Label.CENTER);
        //-----------------------------------------//
